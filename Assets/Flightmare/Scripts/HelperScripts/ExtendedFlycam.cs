  ...
  public class ExtendedFlycam : MonoBehaviour
  {
    ...
    */
    ...
    void Update()
    {
      ...
      if (Input.GetKey(KeyCode.T)) { rotationY -= cameraSensitivity * Time.deltaTime; }
      if (Input.GetKey(KeyCode.G)) { rotationY += cameraSensitivity * Time.deltaTime; }
