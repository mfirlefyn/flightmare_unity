...
namespace RPGFlightmare
{
  public class Scenes
  {
    ...
    public const string SCENE_OWN = "Environments/Nature/ForrestScene";
    public const string SCENE_GRADCAM = "Environments/Gradcam/GradcamScene";
    public const string SCENE_PROCGEN = "Packs/procGen/Scenes/Scene";
    //
    ...
    public Scenes()
    {
      ...
      scenes_list.Add(SCENE_OWN);
      scenes_list.Add(SCENE_GRADCAM);
      scenes_list.Add(SCENE_PROCGEN);
